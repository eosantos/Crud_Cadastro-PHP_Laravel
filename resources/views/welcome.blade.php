                    ...
                    <form action="{{ route('salvar') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <label valign="middle" style="font-family: arial ;color:#0A0A2A; font-size:12px;"><b>Sobrenome:</b></label>
                                <input style="width:445px;" name="sobrenome" type="text" class="form-control" placeholder="Sobrenome">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <label valign="middle" style="font-family: arial ;color:#0A0A2A; font-size:12px;"><b>Data de Nascimento:</b></label>
                                <input name="dt_nasc" type="text" class="form-control" placeholder="__/__/____">
                            </div>

                            <div class="col-6">
                            <label valign="middle" style="font-family: arial ;color:#0A0A2A; font-size:12px;"><b>Telefone:</b></label>
                                <input style="width:320px;" name="telefone" type="text" class="form-control" placeholder="Telefone">
                            </div>
                            ...
                            <div align="center" style="padding-top: 50px;">
                                <input style="width: 200px;" class="btn btn-dark" type="submit" value="salvar">
                                <a href="/listar" style="width: 200px;" class="btn btn-dark">listar</a>
                            </div>
